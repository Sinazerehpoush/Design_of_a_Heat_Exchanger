...
* **Validation:** Verified against [TEMA Class R](https://tema.org/) standards and modeled via [HTRI Xchanger Suite](https://www.htri.net/).
...
* **Tube Metallurgy:** Austenitic Stainless Steel 304. *Note: Strictly excludes all copper-based alloys (e.g., admiralty brass, naval brass) due to catastrophic ammonia stress-corrosion cracking (SCC).*
